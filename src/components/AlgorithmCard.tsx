...
import { Network, Database, Copy, Check, Info, Binary, TableProperties } from 'lucide-react';
...
export default function AlgorithmCard({ huffman, lzw }: AlgorithmCardProps) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-4">
      ...
      >
        ...
        <div>
          ...
          {/* Encoded Preview Segment */}
          <div className="bg-slate-950/80 rounded-2xl border border-white/[0.06] p-4.5 relative group/preview">
            ...
            <p className="text-[11.5px] font-mono text-slate-300 break-all leading-relaxed select-text select-all font-medium whitespace-pre-wrap max-h-20 overflow-y-auto pr-1">
